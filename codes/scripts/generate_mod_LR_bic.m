...
input_folder = '/sdd/wlzhang/data/DF2K_HR';
%save_mod_folder = '/home/wlzhang/BasicSR/data_samples/urban100_mod';
save_LR_folder = '/sdd/wlzhang/data/DF2K800_bicLRx4';
% save_bic_folder = '';
...
for i = 1 : length(filepaths)
    ...
    elseif strcmp(imname, '.')
        ...
        %sigma = 1.8;
        %image_kernel =  fspecial('gaussian',21, sigma); % 7x7 Gaussian kernel k_d with width 1.6
        %img = imfilter(img,double(image_kernel),'replicate'); % blur
